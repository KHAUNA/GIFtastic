...
Psuedo Code:
Set inital array of button options (we will allow user to add more button)

add result images to divs, set with will move divs to 
next line as more are added